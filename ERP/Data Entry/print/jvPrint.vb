...
Public Class jvPrint
    Public Property jvNoGot As Integer
    ...
    Private Sub jvPrint_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If jvNoGot <> Nothing Then
            Call loadAll()
        Else
            Me.Close()
        End If
    ...
    Private Sub loadAll()
        ...
        'First Parameter for JV number
        pfield1.Name = "vrNo"
        pdiscrete1.Value = jvNoGot
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\de\jv.rpt")
