...
Public Class cpvPrint
    Public Property cpvNoGot As Integer
    ...
    Private Sub cpvPrint_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If cpvNoGot <> Nothing Then
            Call loadAll()
        Else
            Me.Close()
        End If
    ...
    Private Sub loadAll()
        ...
        'First Parameter for CPV number
        pfield1.Name = "vrNo"
        pdiscrete1.Value = cpvNoGot
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\de\cpv.rpt")
