...
Public Class bpvPrint
    Public Property bpvNoGot As Integer
    ...
    Private Sub bpvPrint_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If bpvNoGot <> Nothing Then
            Call loadAll()
        Else
            Me.Close()
        End If
    ...
    Private Sub loadAll()
        ...
        'First Parameter for BPV number
        pfield1.Name = "vrNo"
        pdiscrete1.Value = bpvNoGot
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\de\bpv.rpt")
