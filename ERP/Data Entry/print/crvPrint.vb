...
Public Class crvPrint
    Public Property crvNoGot As Integer
    ...
    Private Sub crvPrint_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If crvNoGot <> Nothing Then
            Call loadAll()
        Else
            Me.Close()
        End If
    ...
    Private Sub loadAll()
        ...
        'First Parameter for CRV number
        pfield1.Name = "vrNo"
        pdiscrete1.Value = crvNoGot
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\de\crv.rpt")
