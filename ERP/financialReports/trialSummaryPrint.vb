...
Public Class trialSummaryPrint
    Public Property dateON As String
    Dim constr As String = ConfigurationManager.ConnectionStrings("erpConnect").ConnectionString

    Private Sub trialSummaryPrint_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\fr\trial_summary_r1.rpt")
