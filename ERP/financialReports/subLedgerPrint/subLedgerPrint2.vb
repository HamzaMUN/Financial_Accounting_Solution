...
Public Class subLedgerPrint2
    ...
    Private Sub subLedgerPrint2_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Call loadAll()
    End Sub
    ...
    Private Sub loadAll()
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\fr\sub_l_2_r1.rpt")
