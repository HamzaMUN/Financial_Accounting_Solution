...
Public Class subLedgerPrint4
    ...
    Private Sub subLedgerPrint4_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Call loadAll()
    End Sub
    ...
    Private Sub loadAll()
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\fr\sub_l_4_r1.rpt")
