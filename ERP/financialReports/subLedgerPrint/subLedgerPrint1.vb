...
Public Class subLedgerPrint1
    ...
    Private Sub subLedgerPrint1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Call loadAll()
    End Sub
    ...
    Private Sub loadAll()
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\fr\sub_l_1_r1.rpt")
