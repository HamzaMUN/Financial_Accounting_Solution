...
Public Class coaWSubLedgerDetailPrint
    ...
    Private Sub coaWSubLedgerDetailPrint_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call loadAll()
    End Sub
    ...
    Private Sub loadAll()
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\fr\coa_W_sub_l_r1.rpt")
