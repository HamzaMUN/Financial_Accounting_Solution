...
Public Class trialSummaryPostedPrint
    Public Property dateON As String
    Dim constr As String = ConfigurationManager.ConnectionStrings("erpConnect").ConnectionString

    Private Sub trialSummaryPostedPrint_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        'First Parameter for dateON
        pfield1.Name = "dateOn"
        pdiscrete1.Value = dateON
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\fr\trial_summary_r2.rpt")
