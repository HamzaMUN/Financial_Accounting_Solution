...
Public Class coaLedgerRangePrint
    Public Property startDate As String
    Public Property endDate As String
    Public Property l3AcId1 As Integer
    Public Property l3AcId2 As Integer
    ...
    Private Sub coaLedgerRangePrint_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Call loadAll()
    End Sub
    ...
    Private Sub loadAll()
        ...
        Dim acCode1, acCode2 As Integer
        If l3AcId1 < l3AcId2 Then
            acCode1 = l3AcId1
            acCode2 = l3AcId2
        ElseIf l3AcId1 > l3AcId2 Then
            acCode1 = l3AcId2
            acCode2 = l3AcId1
        Else
            acCode1 = l3AcId1
        ...
        pfield3.Name = "acCode"
        pdiscrete3.Value = acCode1
        pfield3.CurrentValues.Add(pdiscrete3)
        pfields.Add(pfield3)

        'Fourth Parameter for Level 3 Account Code
        pfield4.Name = "acCode2"
        pdiscrete4.Value = acCode2
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\fr\coa_l_range_r1.rpt")
