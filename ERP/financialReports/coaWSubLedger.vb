...
Public Class coaWSubLedger
    ...
    Private Sub coaWSubLedger_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call loadDate()
    ...
    Private Sub genSummaryReport()
        ...
        coaWSubLedgerSummaryPrint.fiscalYearIDGot = fiscalYearIDGot
        coaWSubLedgerSummaryPrint.startDate = startDateRpt
        coaWSubLedgerSummaryPrint.endDate = endDateRpt
        coaWSubLedgerSummaryPrint.Show()
    End Sub
    ...
    Private Sub genDetailReport()
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Message", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End Try
        coaWSubLedgerDetailPrint.startDate = fromDateGot
        coaWSubLedgerDetailPrint.endDate = toDateGot
        coaWSubLedgerDetailPrint.fiscalYearIDGot = fiscalYearIDGot
        coaWSubLedgerDetailPrint.Show()
    End Sub
