...
Public Class coaReport1
    Public Property fiscalYearIDGot
    Dim constr As String = ConfigurationManager.ConnectionStrings("erpConnect").ConnectionString

    Private Sub coaReport1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        crReportDocument.Load("D:\Hexagon Solutions\ERP\rpt\fr\coa_r1.rpt")
