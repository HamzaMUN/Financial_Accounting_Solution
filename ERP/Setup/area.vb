        ...
        Else
            Try
                If saveType = "new" Then
                    ...
                    Dim valcommand1 As New SqlCommand("SELECT * FROM area WHERE areaName = @input1got", conn)
                    ...
                    If valtable1.Rows.Count() <= 0 Then
                        comm = New SqlCommand("INSERT INTO area(areaName) VALUES ('" & nameInput.Text & "' )", conn)
                ...
                ElseIf saveType = "update" Then
                    ...
                    conn = New SqlConnection(constr)
                    conn.Open()
                    comm = New SqlCommand("UPDATE area SET areaName = '" & nameInput.Text & "' WHERE areaID = '" & codeInput.Text & "' ", conn)
                    affector = comm.ExecuteNonQuery
    ...
    Private Sub DeleteToolStripMenuItem_Click(ByVal sender As Object, ByVal e As EventArgs) Handles DeleteToolStripMenuItem.Click
        ...
        If valtable1.Rows.Count() <= 0 Then
            ...
            If delresponse = MsgBoxResult.Yes Then
                comm = New SqlCommand("DELETE FROM area WHERE areaID = '" & codeGot & "' ", conn)
                affector = comm.ExecuteNonQuery
                Call clearAll()
