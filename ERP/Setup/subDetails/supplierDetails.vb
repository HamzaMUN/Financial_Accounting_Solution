...
Public Class supplierDetails
    ...
    Public Property supplierIDGot As String
    Private Sub supplierDetails_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        codeInput.Text = supplierIDGot
        Try
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        conn = New SqlConnection(constr)
        conn.Open()
        comm = New SqlCommand("UPDATE subsidiaryLedger SET subsidiaryAddress = '" & addressInput.Text & "',subsidiaryLandlineNo = '" & landlineInput.Text & "',subsidiaryMobileNo = '" & mobileInput.Text & "',subsidiaryContactPerson = '" & contactPersonInput.Text & "',subsidiaryEmail = '" & emailInput.Text & "',ntn = '" & ntnInput.Text & "' WHERE subsidiaryLedgerID = '" & supplierIDGot & "' ", conn)
        ...
        Call loadRecordsAll()
    End Sub
    Private Sub supplierDetails_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
