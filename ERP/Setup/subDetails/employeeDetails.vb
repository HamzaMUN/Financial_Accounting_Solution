...
Public Class employeeDetails
    ...
    Public Property employeeIDGot As String
    Private Sub employeeDetails_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        codeInput.Text = employeeIDGot
        Try
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        conn = New SqlConnection(constr)
        conn.Open()
        comm = New SqlCommand("UPDATE subsidiaryLedger SET subsidiaryAddress = '" & addressInput.Text & "',subsidiaryLandlineNo = '" & landlineInput.Text & "',subsidiaryMobileNo = '" & mobileInput.Text & "',subsidiaryContactPerson = '" & contactPersonInput.Text & "',subsidiaryEmail = '" & emailInput.Text & "',ntn = '" & ntnInput.Text & "' WHERE subsidiaryLedgerID = '" & employeeIDGot & "' ", conn)
        ...
        Call loadRecordsAll()
    End Sub
    Private Sub employeeDetails_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
